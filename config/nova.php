...
return [
    ...
    */
    ...
    'brand' => [
        ...
        'logo_src' => 'https://educacao.mangaratiba.rj.gov.br/img/brasao-pmm-smeel-black.png', // versão Dark
        'logo_src_dark' => 'https://educacao.mangaratiba.rj.gov.br/img/logo-pmm-branco.png', // versão Branca
        'logo_href' => 'https://educacao.mangaratiba.rj.gov.br/admin',
        'logo_class' => 'h-10',
     ...
     */
    'http' => [
        'verify' => false, // Desabilita verificação SSL (use apenas em desenvolvimento)
    ],
