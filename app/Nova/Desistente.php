...
/**
 * Este resource exibe os alunos desistentes
 * (status = 12) a partir da tabela matriculas.
 */
class Desistente extends Resource
{
    /**
     * Model correto
     *
    ...
    /**
     * Filtro do index: apenas alunos desistentes
     */
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->where('situacao_matricula', 12);
    }
