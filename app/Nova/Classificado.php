...
/**
 * Este resource exibe os alunos classificados
 * (status = 5) a partir da tabela matriculas.
 */
class Classificado extends Resource
{
    /**
     * Model correto
     *
    ...
    {
        return 'Aptos a fazer matrícula';
    }
    ...
    /**
     * Filtro do index: apenas alunos classificados
     */
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->where('situacao_matricula', 13);
    }
