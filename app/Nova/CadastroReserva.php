...
/**
 * Este resource exibe os alunos em cadastro de reserva
 * (status = 9) a partir da tabela matriculas.
 */
class CadastroReserva extends Resource
{
    /**
     * Model correto
     *
    ...
    /**
     * Filtro do index: apenas alunos em cadastro de reserva
     */
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->where('situacao_matricula', 9);
    }
    ...
    {
        return [
            new Filters\EscolaMatriculaFilter,
        ];
    }
