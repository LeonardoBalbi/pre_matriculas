...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    ...
    protected function gate()
    {
        Gate::define('viewNova', function ($user) {
            return $user && (
                ...
                || (method_exists($user, 'hasRole') && ($user->hasRole('super-admin') || $user->hasRole('admin_edu') || $user->hasRole('colegio')))
            );
        });
    }
    ...
    {
        // Registra automaticamente todos os resources da pasta app/Nova
