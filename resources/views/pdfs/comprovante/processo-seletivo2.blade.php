...
<head>
    ...
    <title>PROCESSO SELETIVO SIMPLIFICADO - EDITAL 01/2025</title>
</head>
<style>
    @page {
        margin: 0px;
...
<body>
    ...
    <div class="row">
        ...
        <div class="text-processo">
            <h5>PROCESSO SELETIVO SIMPLIFICADO - EDITAL 01/2025</h5>
        </div>
    </div>
    <br>
    <hr>
    ...
    <div class="row">
        ...
        <div class="text-left">
            <p>
             ...
             <strong>CPF:</strong> {{ $candidato->cpf }} - <strong>Vaga Pretendida:</strong> {{$vaga->titulo}}
            </p>
        </div>
