<?php $__env->startSection('content'); ?>
            ...
            <div class="container-fluid px-3 px-md-4">
                ...
                <div class="collapse navbar-collapse show" id="mainNavbar">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-lg-3 gap-lg-3">
                        ...
                        <li class="nav-item"><a class="nav-link text-white fw-bold active" style="font-size: 1rem !important; opacity: 1 !important; visibility: visible !important;" href="<?php echo e(route('register.pre-matricula.status')); ?>">Área do candidato</a></li>
                    </ul>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $etapas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etapa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="col">
                            <div class="card h-100 shadow-lg border-0 text-center p-4">
                                <div class="d-flex align-items-center justify-content-center rounded-circle mb-3 etapa-circle <?php echo e($etapa['bg']); ?>">
                                    <span class="fw-bold text-white fs-4"><?php echo e($etapa['etapa']); ?></span>
                                </div>
                                <h3 class="h5 fw-bold mb-2"><?php echo e($etapa['titulo']); ?></h3>
                                <p class="text-muted mb-0"><?php echo e($etapa['descricao']); ?></p>
                            </div>
                        </div>
        ...
        <section id="UnidadesEscolares" class="pt-5 pb-5 bg-gradient-soft-2">
            <div class="container">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="filtroBairro" class="form-select">
                            <option value="">Todos</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bairros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bairro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($bairro); ?>"><?php echo e($bairro); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                ...
                <div class="row g-4" id="gridUnidades">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $escolas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="col-md-6 col-lg-4 unidade-item"
                             data-distrito="<?php echo e($unidade['distrito'] ?? ''); ?>"
                             data-bairro="<?php echo e($unidade['bairro'] ?? ''); ?>">
                            <div class="card h-100 shadow-sm unidade-card"
                                 data-id="<?php echo e($unidade['id']); ?>"
                                 data-nome="<?php echo e($unidade['nome']); ?>"
                                 data-endereco="<?php echo e($unidade['endereco'] ?? ''); ?>"
                                 data-img="<?php echo e($unidade['foto_url'] ?? '/images/icons/favicon.ico'); ?>"
                                 data-distrito="<?php echo e($unidade['distrito'] ?? ''); ?>"
                                 data-bairro="<?php echo e($unidade['bairro'] ?? ''); ?>">
                                <img src="<?php echo e($unidade['foto_url'] ?? '/images/icons/favicon.ico'); ?>"
                                     class="card-img-top unidade-img"
                                     alt="<?php echo e($unidade['nome']); ?>"
                                     onerror="this.src='/images/icons/favicon.ico'">
                                <div class="card-body text-center">
                                    <h5 class="card-title text-primary fw-bold"><?php echo e($unidade['nome']); ?></h5>
                                    <p class="card-text text-muted small mb-0"><?php echo e($unidade['endereco'] ?? ''); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script src="<?php echo e(asset('js/bot_educacao.js')); ?>"></script>
        <script>
            (function () {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\app_filament5_inicio\app\resources\views/index.blade.php ENDPATH**/ ?>